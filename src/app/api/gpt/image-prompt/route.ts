...
export async function POST(req: Request) {
  ...
  const developer = [
    ...
    "",
    "Example 1 (FR):",
    "génère maintenant une image de ce monsieur dans une salle de bain moderne qui se regarde dans le miroir avec un air de confiance et d’assurance en soi, qui se sent bien et que la chemise lui aille bien, elle fait une belle silhouette, son ventre ne paraît pas gros et il a l’air d’avoir des épaules bien en valeur et de gros bras avec une belle carrure, et il tient ses cols comme s’il les ajustait avec élégance.",
    "",
    "Example 2 (EN):",
