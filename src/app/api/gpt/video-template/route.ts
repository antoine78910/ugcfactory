...
export async function POST(req: Request) {
  ...
  const developer = [
    ...
    "- If context suggests a transparent protective cap and micro-tips, explicitly include removing the cap and revealing the tip area before application.",
    "- Include practical usage choreography: hold product at natural distance (not too close), show key part, apply with realistic controlled movement, then optional after-gesture (e.g. massage area).",
    "- Avoid vague actions; movement instructions must be concrete and filmable.",
    "",
