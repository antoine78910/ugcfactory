...
function soonRowClass(): string {
  return [
    "flex w-full min-h-[3.35rem] flex-row items-center justify-between gap-2 rounded-xl border border-white/10 bg-white/[0.03] px-3 py-3 text-left",
...
function navButtonClass(active: boolean): string {
  return [
    "block w-full min-w-0 rounded-lg px-3.5 py-3 text-left text-[13px] font-semibold transition-all cursor-pointer leading-snug",
    active
