              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <Link
                    ...
                    className={
                      tool.ctaPrimary
                        ? "mt-5 inline-flex items-center justify-center gap-1.5 rounded-xl bg-violet-600 px-4 py-2.5 text-xs font-semibold text-white transition hover:bg-violet-500"
                        : "mt-5 inline-flex items-center justify-center gap-1.5 rounded-xl border border-white/15 bg-white/[0.04] px-4 py-2.5 text-xs font-semibold text-white/90 transition hover:bg-white/[0.08]"
                    }
                  >
                    {tool.cta}
