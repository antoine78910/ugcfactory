        ...
        <div className="relative mx-auto max-w-3xl space-y-10 px-5 py-10 md:px-8 md:py-12">
          ...
          <header className="space-y-3">
            ...
            <p className="max-w-xl text-sm leading-relaxed text-white/50">
              On the free plan, generations use your kie.ai key so usage is billed on your Kie account. Keys stay in
              your browser (localStorage). Paid plans can keep using platform credits instead.
            </p>
          </header>
            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h2 className="text-sm font-bold text-white">Kie API (kie.ai)</h2>
                    <p className="mt-1 text-xs leading-relaxed text-white/45">
                      Personal key for image and video generation: usage is billed to your kie.ai account; no platform
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {elevenKey.trim() ? (
                    ...
                    <p className="text-[11px] text-emerald-300/60">
                      Enter a key to use your own account for voice change.
                    </p>
                  )}
                </div>
              ) : null}
