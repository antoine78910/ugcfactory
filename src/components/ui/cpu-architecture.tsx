  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 4th */}
        {!pulseFromTop ? <path d="M 170 80 v -21.8 q 0 -5 -5 -5 h -50" /> : null}
        {/* 5th */}
        {!pulseFromTop ? (
          <path
            strokeDasharray="100 100"
        ...
        {/* 6th */}
        {!pulseFromTop ? <path d="M 94.8 95 v -36" /> : null}
        {/* 7th */}
        {!pulseFromTop ? <path d="M 88 88 v -15 q 0 -5 -5 -5 h -10 q -5 0 -5 -5 v -5 q 0 -5 5 -5 h 14" /> : null}
        {/* 8th */}
